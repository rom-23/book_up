    ...
    _createClass(TableSortable, [{
        ...
        value: function generatePagination() {
            ...
            var rows = data.length,
                index = 0;
            var prevBtn = $('<button class="btn btn-outline-success prev">Prev</button>'),
                nextBtn = $('<button class="btn btn-outline-success next">Next</button>'),
                btnDotsLeft = $('<button class="btn btn-outline-success" disabled="true">...</button>'),
                btnDotsRight = $('<button class="btn btn-outline-success" disabled="true">...</button>');
       ...
       /*         $.each($("#myTable i"), function () {
            ...
            if (this.controlRow) {
                if (showPaginationLabel) {
                    var showLabel = '<span class="page-label"style="color: #81827f;font-size: 12px;">Showing ' + (this.leftBase + 1) + ' to ' + this.rightBase + ' of ' + data.length + ' entries</span>';
